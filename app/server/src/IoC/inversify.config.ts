...
import { IMetadataExtractor } from "../metadataExtractor/metadataExtractor";
import { AllocineMetadataExtractor } from "../metadataExtractor/allocineMetadataExtractor";
...
container.bind<IMetadataExtractor>("extractors").to(AllocineMetadataExtractor);
